        ...
        for dataset_name in _dataset_names:
            ...
            for clients_distribution in _clients_distributions:
                ...
                for server_type in _server_types:
                    ...
                    if 'split_type' in my_model_configuration.keys():
                        if my_model_configuration['split_type'] == 'standard_non_iid':
                            for alpha in np.arange(0.1, 1, 0.2):
                                my_model_configuration['alpha'] = alpha
                                all_processes.append(
                                    sub_main(
                                        configuration_variables,
                                        copy.deepcopy(my_model_configuration),
                                        my_server_configuration,
                                        my_clients_distribution
                                    )
                                )
