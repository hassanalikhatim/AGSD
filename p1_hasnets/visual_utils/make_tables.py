...
def outnumbering_backdoored_clients_analysis(dataset_names, results_path_local: str, save_fig: bool=True):
    ...
    nicer_names = {
        ...
        'clean': 'Clean', 
        'simple_(poison-0.75)_(scale-2)': 'VTBA',
        'hasnet_heldout_(num_clients-100)_(clients_ratio-0.1)_(healing_set_size-50)': 'HGSD (ID-50)',
        'hasnet_heldout_(num_clients-100)_(clients_ratio-0.1)_(healing_set_size-100)': 'HGSD (ID-100)',
        'hasnet_ood_(num_clients-100)_(clients_ratio-0.1)_(healing_set_size-50)': 'HGSD (OOD-50)',
...
def adaptive_attacks_evaluation_others(dataset_names, results_path_local: str):
    ...
    clients_distributions = [
        ...
        {'simple_(poison-0.25)_(scale-2)': 0.2, 'invisible_(poison-0.25)_(scale-2)_(target-1)': 0.2},
    ]
