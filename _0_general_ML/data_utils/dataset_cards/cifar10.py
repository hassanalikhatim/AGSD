...
class CIFAR10(Torch_Dataset):
    ...
    def renew_data(
        ...
        test_transform += [torchvision.transforms.Normalize((0.491, 0.482, 0.446), (0.247, 0.243, 0.261))] #Normalize all the images
        ...
        train_transform += [torchvision.transforms.Normalize((0.491, 0.482, 0.446), (0.247, 0.243, 0.261))] #Normalize all the images
