...
class Server_Krum(Server):
    ...
    def aggregate(
        ...
        **kwargs
        ...
        flattened_clients_state_dict = [
            self.flatten_client_state(client_state) for client_state in clients_state_dict
        ]
    ...
    def compute_client_scores(
        ...
        current_client_scores = np.array([
            np.mean(np.abs(flattened_client_state_dict - flattened_client_state_2)) 
            for flattened_client_state_2 in flattened_clients_state_dict
        ])
